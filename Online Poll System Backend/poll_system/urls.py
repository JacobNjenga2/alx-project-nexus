...
schema_view = get_schema_view(
    openapi.Info(
        ...
        default_version='v1',
        description="""
        A comprehensive REST API for an online poll system.
        
        ## Features
        - Create and manage polls with multiple options
        - Real-time voting with duplicate prevention
        - Poll results with vote counts and percentages
        - User authentication and authorization
        - Voting statistics and analytics
        
        ## Authentication
        Most endpoints allow anonymous access for voting.
        Authentication is required for creating polls and accessing user-specific data.
        """,
